 ...
 */
export class KCViewerAppElement extends KCUIElement {
    #viewer_elm;
    #activity_bar;
    constructor() {
        super();
    ...
    initialContentCallback() {
        ...
        // as needed.
        this.addDisposable(listen(this.project, "change", async (e) => {
    ...
    make_pre_activities() {
        ...
        if (this.#has_more_than_one_page()) {
            activities.push(html `<kc-ui-activity
                    slot="activities"
                    name="Project"
                    icon="folder">
    ...
    render() {
        ...
        const controlslist = parseFlagAttribute(this.controlslist ?? "", controls == "none"
        ...
        if (controlslist["download"] && !this.#has_more_than_one_page()) {
            top_toolbar_buttons.push(html `<kc-ui-button
                    slot="right"
                    name="download"
                    title="download"
                    icon="download"
...
], KCViewerAppElement.prototype, "controls", void 0);
__decorate([
    attribute({ type: String })
], KCViewerAppElement.prototype, "controlslist", void 0);
__decorate([
    attribute({ type: Boolean })
], KCViewerAppElement.prototype, "sidebarcollapsed", void 0);
