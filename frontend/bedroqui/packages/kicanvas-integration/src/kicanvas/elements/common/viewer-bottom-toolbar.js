...
import { KiCanvasMouseMoveEvent, KiCanvasSelectEvent, } from "../../../viewers/base/events";
export class KCViewerBottomToolbarElement extends KCUIElement {
    ...
    connectedCallback() {
        (async () => {
            ...
            this.addDisposable(this.viewer.addEventListener(KiCanvasMouseMoveEvent.type, () => {
    ...
    update_position() {
        ...
        this.#position_elm.value = `${pos.x.toFixed(2)}, ${pos.y.toFixed(2)} mm`;
    }
    render() {
...
window.customElements.define("kc-viewer-bottom-toolbar", KCViewerBottomToolbarElement);
