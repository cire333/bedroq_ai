...
export declare class ContextRequestEvent<T = unknown> extends Event {
    ...
    private _callback;
    static type: string;
    constructor(context_name: string, _callback: ContextRequestCallback<T>);
 ...
 */
export declare function requestContext<T = unknown>(target: EventTarget, context_name: string): Promise<T>;
/**
 ...
 */
export declare function provideContext<T>(target: EventTarget, context_name: string, context: T): void;
/**
 ...
 */
export declare function requestLazyContext<T = unknown>(target: EventTarget, context_name: string): Promise<T>;
/**
 * Like provideContext but used with requestLazyContext
 */
export declare function provideLazyContext<T = unknown>(target: EventTarget, context_name: string, context: () => T): Promise<void>;
/**
 * Mixin used to add provideContext and requestContext methods.
 */
export declare function WithContext<T extends Constructor<HTMLElement>>(Base: T): {
    new (...args: any[]): {
        /** Request context from ancestors */
        requestContext<T_1 = unknown>(context_name: string): Promise<T_1>;
        /** Provide context to descendants */
        provideContext<T_2 = unknown>(context_name: string, context: T_2): void;
        /** Request context from ancestors lazily */
        requestLazyContext<T_3 = unknown>(context_name: string): Promise<T_3>;
        /** Provide context to descendants lazily */
        provideLazyContext<T_4 = unknown>(context_name: string, context: () => T_4): void;
        accessKey: string;
        ...
        appendChild<T_5 extends Node>(node: T_5): T_5;
        ...
        normalize(): void;
        removeChild<T_7 extends Node>(child: T_7): T_7;
        replaceChild<T_8 extends Node>(node: Node, child: T_8): T_8;
