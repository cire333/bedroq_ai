...
import { GlobalLabelPainter, HierarchicalLabelPainter, LabelPainter, } from "../../../src/viewers/schematic/painters/label";
const renderer = new NullRenderer();
const layer_set = new ViewLayerSet();
const document_painter = new DocumentPainter(renderer, layer_set, witch_hazel.board);
