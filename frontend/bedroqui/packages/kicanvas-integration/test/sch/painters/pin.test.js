...
import { PinLabelInternals, PinPainter, PinShapeInternals, } from "../../../src/viewers/schematic/painters/pin";
...
suite("sch.painters.pin.PinShapeInternals", function () {
    test(".stem()", function () {
        ...
        assert.equal(stem.dir.x, 0);
        assert.equal(stem.dir.y, 1);
        stem = PinShapeInternals.stem(new Vec2(1460500, 800100), "right", 25400);
...
suite("sch.painters.pin.PinLabelInternals", function () {
    ...
    test(".place_above()", function () {
        let placement;
        placement = PinLabelInternals.place_above(text_margin, pin_thickness, text_thickness, pin_length, "right");
        ...
        placement = PinLabelInternals.place_above(text_margin, pin_thickness, text_thickness, pin_length, "left");
        assert.equal(placement.offset.x, -12700);
        assert.equal(placement.offset.y, -2540);
        assert.equal(placement.h_align, "center");
        assert.equal(placement.v_align, "bottom");
        assert.equal(placement.orientation, "left");
        placement = PinLabelInternals.place_above(text_margin, pin_thickness, text_thickness, pin_length, "down");
        assert.equal(placement.offset.x, -2540);
        assert.equal(placement.offset.y, 12700);
        assert.equal(placement.h_align, "center");
        assert.equal(placement.v_align, "bottom");
        assert.equal(placement.orientation, "down");
        placement = PinLabelInternals.place_above(text_margin, pin_thickness, text_thickness, pin_length, "up");
        assert.equal(placement.offset.x, -2540);
        assert.equal(placement.offset.y, -12700);
        assert.equal(placement.h_align, "center");
        assert.equal(placement.v_align, "bottom");
    ...
    test(".place_below()", function () {
        let placement;
        placement = PinLabelInternals.place_below(text_margin, pin_thickness, text_thickness, pin_length, "right");
        assert.equal(placement.offset.x, 12700);
        assert.equal(placement.offset.y, 2540);
        assert.equal(placement.h_align, "center");
        assert.equal(placement.v_align, "top");
        assert.equal(placement.orientation, "right");
        placement = PinLabelInternals.place_below(text_margin, pin_thickness, text_thickness, pin_length, "left");
        assert.equal(placement.offset.x, -12700);
        assert.equal(placement.offset.y, 2540);
        assert.equal(placement.h_align, "center");
        assert.equal(placement.v_align, "top");
        assert.equal(placement.orientation, "left");
        placement = PinLabelInternals.place_below(text_margin, pin_thickness, text_thickness, pin_length, "down");
        assert.equal(placement.offset.x, 2540);
        assert.equal(placement.offset.y, 12700);
        assert.equal(placement.h_align, "center");
        assert.equal(placement.v_align, "top");
        assert.equal(placement.orientation, "down");
        placement = PinLabelInternals.place_below(text_margin, pin_thickness, text_thickness, pin_length, "up");
        assert.equal(placement.offset.x, 2540);
        assert.equal(placement.offset.y, -12700);
        assert.equal(placement.h_align, "center");
        assert.equal(placement.v_align, "top");
    ...
    test(".place_inside()", function () {
        let placement;
        placement = PinLabelInternals.place_inside(text_offset, text_thickness, pin_length, "left");
        ...
        assert.equal(placement.orientation, "left");
        placement = PinLabelInternals.place_inside(text_offset, text_thickness, pin_length, "right");
        assert.equal(placement.offset.x, 29718);
        assert.equal(placement.offset.y, 0);
        assert.equal(placement.h_align, "left");
        assert.equal(placement.v_align, "center");
        assert.equal(placement.orientation, "right");
        placement = PinLabelInternals.place_inside(text_offset, text_thickness, pin_length, "up");
        assert.equal(placement.offset.x, 0);
        assert.equal(placement.offset.y, -29718);
        assert.equal(placement.h_align, "left");
        assert.equal(placement.v_align, "center");
        assert.equal(placement.orientation, "up");
        placement = PinLabelInternals.place_inside(text_offset, text_thickness, pin_length, "down");
        assert.equal(placement.offset.x, 0);
        assert.equal(placement.offset.y, 29718);
        assert.equal(placement.h_align, "right");
        assert.equal(placement.v_align, "center");
