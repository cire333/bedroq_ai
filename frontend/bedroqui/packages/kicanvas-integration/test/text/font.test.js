...
suite("text.font.Font()", function () {
    test(".wordbreak_markup()", function () {
        let words = font["wordbreak_markup"]("hello world 1 2 3", new Vec2(12700, 12700), new TextStyle());
        ...
        words = font["wordbreak_markup"]("hello world ^{1} 2 3", new Vec2(12700, 12700), new TextStyle());
    ...
    test(".break_lines()", function () {
        // TODO
        font.break_lines("hello world ^{1} 2 3", 182880, new Vec2(12700, 12700), 0, false, false);
    });
});
