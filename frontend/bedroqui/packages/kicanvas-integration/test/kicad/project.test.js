...
import { BoardDesignSettings, BoardDesignSettingsDefaults, BoardSettings, ProjectSettings, } from "../../src/kicad/project-settings";
...
suite("kicad.project", function () {
    test("basic", function () {
        ...
        assert.instanceOf(project.board.design_settings.defaults, BoardDesignSettingsDefaults);
